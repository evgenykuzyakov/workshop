...
На этом семинаре вы познакомитесь с основами и научитесь разарабытвать смарт-контракты на языке Rust для NEAR Protocol.
...
Вы должны увидеть холст 50x50. Он может быть немного "uhzpysq", потому что на нем рисуют все юзеры (одновременно и по очереди).
